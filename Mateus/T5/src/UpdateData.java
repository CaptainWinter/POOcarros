		...
		SingleAbstractMethod myInterface = (p1, p2, p3) -> {
			...
			case 1:
				if (myBool) {
					...
					if(!RequestData.availableBranches(p2))
						break;
				}
			...
			case 2:
				...
				if (p3) {
					...
					if (p1.addCustomer(branchName, customerName, customerInitialAmount)) {
						...
						p1.addCustomer(branchName, customerName, customerInitialAmount);
					} else {
					...
					if (p1.deleteCustomer(branchName, customerName)) {
						...
						p1.deleteCustomer(branchName, customerName);
					} else {
			...
			case 3:
				...
				if (p3) {
					...
					if (p1.addCar(branchName, customerName, carName, carPricePerDay)) {
						...
						p1.addCar(branchName, customerName, carName, carPricePerDay);
					} else {
					...
					if (p1.deleteCar(branchName, customerName, carName)) {
						...
						p1.deleteCar(branchName, customerName, carName);
					} else {
